...
--
-- Host: localhost
-- Generation Time: Jul 12, 2020 at 02:49 PM
...
CREATE TABLE `area` (
  ...
  `area_name` varchar(22) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
...
INSERT INTO `area` (`id`, `area_id`, `area_name`, `created_date`, `modified_date`, `created_by`, `modified_by`, `status`) VALUES
(1, 'che', 'chennai1', '2020-07-12 14:35:46', '2020-07-12 14:48:13', 1234, 12345, 0),
(2, 'trz', 'trichy', '2020-07-12 14:44:41', NULL, 12345, NULL, 1);
